...
const Contact = ({ id }) => {
  ...
  return (
    <>
      <section
        id={id}
        className="bg-[#EAF3FF] px-12 md:px-20 pb-[10vh] pt-[5vh]"
      >
        <div className="flex flex-col text-center items-center">
          ...
          <p className="text-gray-600 my-6 w-full md:max-w-[50%]">
            We'd love to hear from you! Whether you have a specific enquiry or
            you just want to receive more information 
          </p>
        </div>
        ...
        <div className="max-w-full mx-auto grid grid-cols-1 md:grid-cols-[2fr,3fr] gap-8">
          <div className="space-y-10">
            ...
            <p className="text-gray-600 text-justify">
              ...
              filling out the form or you can directly call us on our given
              number to discuss anything you have. We shall get back to you as
              soon as we receive your queries.
            </p>
